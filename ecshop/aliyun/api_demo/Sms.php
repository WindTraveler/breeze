...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIheLMxAx1mmDw"; // AccessKeyId

        $accessKeySecret = "psT8cz8PgQKfw2ZzE48BjDeAfk6kET"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($moblie) {
        ...
        // 必填，设置短信接收号码
//        $request->setPhoneNumbers("13811690105");
        $request->setPhoneNumbers($moblie);
        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("微风");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_133020134");

        // 可选，设置模板参数, 假如模板中存在变量需要替换则为必填项
        session_start();
        $sms_code = rand(1000,9999);
        $_SESSION['sms_code_my'] = $sms_code;
        echo $sms_code . "\n";
...
$mobile_arr = (array)json_decode($_REQUEST['JSON']);
$moblie = $mobile_arr['mobile'];
$response = Sms::sendSms($moblie);
$res = array('content'=>'succ');
