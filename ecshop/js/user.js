...
function send_sms(){
  if(wait == 120){
    ...
    btn.value = '发送中';
    var filter = new Object;
    filter.mobile = document.getElementById("mobile").value;
    //Ajax.call('user.php?act=ajax_validate_sms', filter, send_result, 'POST', 'JSON');
    Ajax.call('/aliyun/api_demo/Sms.php', filter, send_result, 'POST', 'JSON');
  }
}
