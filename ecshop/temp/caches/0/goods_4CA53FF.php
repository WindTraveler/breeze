...
<title>杰威尔（JVR） 男士绿茶多酚控油净痘面膜_个人护理_微风 - Powered by ECShop</title>
...
<div class="block box">
  <div id="ur_here"> <div class="path"><div>当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">个人护理</a> <code>&gt;</code> 杰威尔（JVR） 男士绿茶多酚控油净痘面膜</div></div> </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
  ...
  <div class="AreaR">
    ...
    <div id="goodsInfo" class="clearfix">
      ...
      <div class="imgInfo">
                <a href="javascript:;" onclick="window.open('gallery.php?id=6'); return false;"> <img src="images/201804/goods_img/6_G_1523525487843.jpg" alt="杰威尔（JVR） 男士绿茶多酚控油净痘面膜"/> </a>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=6&amp;img=6" target="_blank"><img src="images/201804/thumb_img/6_thumb_P_1523525487927.jpg" alt="杰威尔（JVR） 男士绿茶多酚控油净痘面膜" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      <div class="textInfo">
        <form action="javascript:addToCart(6)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          <div class="goods_style_name"> 杰威尔（JVR） 男士绿茶多酚控油净痘面膜 </div>
          <ul>
                        <li class="clearfix">
              <dd>
       ...
       <strong>累计销量：</strong>0       </dd>
            ...
            <li class="clearfix">
              <dd>
                                <strong>市场价格：</strong><font class="market">￥84元</font> </dd>
                            
              <dd><strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥70元</font> </dd>
                            <dd><strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥70元</font> </dd>
                          </li>
                                    <li class="clearfix">
