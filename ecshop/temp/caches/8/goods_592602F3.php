...
<title>善存(Centrum) 佳维片家庭装 复合维生素 1.33g*120片_营养保健_微风 - Powered by ECShop</title>
...
<div class="block box">
  <div id="ur_here"> <div class="path"><div>当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">营养保健</a> <code>&gt;</code> 善存(Centrum) 佳维片家庭装 复合维生素 1.33g*120片</div></div> </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
  ...
  <div class="AreaR">
    ...
    <div id="goodsInfo" class="clearfix">
      ...
      <div class="imgInfo">
                <a href="javascript:;" onclick="window.open('gallery.php?id=2'); return false;"> <img src="images/201804/goods_img/2_G_1523520058477.jpg" alt="善存(Centrum) 佳维片家庭装 复合维生素 1.33g*120片"/> </a>
      ...
      <div class="gallery">
        <div id="demo">
          <div id="demo1" style="float:left">
            <ul>
                         <li><a href="gallery.php?id=2&amp;img=2" target="_blank"><img src="images/201804/thumb_img/2_thumb_P_1523520058450.jpg" alt="善存(Centrum) 佳维片家庭装 复合维生素 1.33g*120片" class="B_blue" /></a>
            </li>
                        </ul>
          </div>
      ...
      <div class="textInfo">
        <form action="javascript:addToCart(2)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          <div class="goods_style_name"> 善存(Centrum) 佳维片家庭装 复合维生素 1.33g*120片 </div>
          <ul>
                        <li class="clearfix">
              <dd>
       ...
       <strong>累计销量：</strong>0       </dd>
            ...
            <li class="clearfix">
              <dd>
                                <strong>市场价格：</strong><font class="market">￥144元</font> </dd>
                            
              <dd><strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥120元</font> </dd>
                            <dd><strong>注册用户：</strong><font class="shop" id="ECS_RANKPRICE_1">￥120元</font> </dd>
                          </li>
                                    <li class="clearfix">
            ...
            <li class="padd">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="td1"><a href="javascript:addToCart(2)"><img src="themes/default/images/buybtn1.png" /></a></td>
                  <td class="td2"><a href="javascript:collect(2)"><img src="themes/default/images/bnt_colles.gif" /></a></td>
                                    <td class="td3"><a href="user.php?act=affiliate&goodsid=2"><img src='themes/default/images/bnt_recommend.gif'></a> </td>
                                  </tr>
              </table>
            </li>
    ...
    <div class="blank5"></div>
  <div id="ECS_BOUGHT">45ea207d7a2b68c49582d2d22adf953abought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:2;}45ea207d7a2b68c49582d2d22adf953a</div> <div id="ECS_COMMENT"> 45ea207d7a2b68c49582d2d22adf953acomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:2;}45ea207d7a2b68c49582d2d22adf953a</div>
  </div>
