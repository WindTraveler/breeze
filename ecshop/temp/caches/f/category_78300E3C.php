...
<title>中药养生_微风 - Powered by ECShop</title>
...
<div class="clear0 "></div>
 <div class="category-body">
  <div id="ur_here"> <div class="path"><div>当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=4">中药养生</a></div></div> </div>
  ...
  <div class="blank5"></div>
    <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
      ...
      <div class="clearfix goodsBox" style="border:none;">
                        <div class="goodsItem"> <a href="goods.php?id=4" class="img-box"><img src="images/201804/thumb_img/4_thumb_G_1523520313463.jpg" alt="荣事达（Roy..." class="goodsimg" /></a>
        <div class="goods-info">
            <div class="goods-title"><a href="goods.php?id=4" title="荣事达（Royalstar）煎药壶全自动中药壶电熬药锅养生壶陶瓷YSH40A">荣事达（Roy...</a></div>
            <div class="goods-ms">
                          </div>
            <div class="clearfix price-box">
              <div class="shop_s">￥109元</div>
              <a class="price-btn" href="goods.php?id=4">立即购买</a>
            </div>
