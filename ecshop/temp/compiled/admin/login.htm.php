...
<?php if (! $this->_var['certi']['passport_uid']): ?>
<!--云起激活系统面板-->
...
<form class="login-body" method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  ...
  <div class="center-wrap" id="centerWrap">
    ...
    <div class="top-ibg-wrap">
      <a href="<?php echo $this->_var['yunqi_ad_link']; ?>" target="_blank" class="top-ibg-480600"></a>
    </div>
    <div class="z-bd">
...
<!--
  ...
  var is_active = "<?php echo $this->_var['certi']['passport_uid']; ?>";
  /* 未激活站点登录后台必须先激活 */
  if (!is_active) {
