...
?>
          ...
          <?php endif; ?>
          <?php if ($this->_var['var']['code'] == 'sms_order_placed' || $this->_var['var']['code'] == 'sms_order_payed' || $this->_var['var']['code'] == 'sms_order_shipped' || $this->_var['var']['code'] == 'sms_order_payed_to_customer'): ?>
            <span class="act-hover cl-link" style="margin-left: 20px;cursor:pointer" onmouseenter = "actHover(this)" onmouseleave="actLeave(this)"><?php echo $this->_var['lang']['preview_template']; ?></span> <span class="panel-pop"> <?php echo $this->_var['demo_sms_info'][$this->_var['var']['code']]; ?></span>
          <?php endif; ?>
        </td>
      </tr>
